...
export function createSocketIOserver(httpServer: ReturnType<typeof import('http').createServer>) {
...
export function getIO() {
  if (!io) {
    throw new Error('Socket.io not initialized. Call createSocketIOserver first.')
  }
  return io
}
