...
- [x] **02-fulfillment-v2** | `prd-phases/02-launch/prd-02-fulfillment-v2.md` | Instacart IDP full cart API (replace deep-link) + Kroger developer API + Chicory CPG integration | status: complete | requires: 01-verify-runtime |
