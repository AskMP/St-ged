...
1. Implement the weekly calendar and shared list routes first; add planning and collaboration tests afterward to confirm behavior
...
- [x] **Task 1: Implement weekly calendar and shared list routes** `[BD:STG-125]`
  - **Type**: feature
  ...
  - **Verify**: Planning route tests pass once added
  - **Accept**: Users can plan meals and see the corresponding shared grocery list in real routes

- [x] **Task 2: Add planning route and collaboration tests** `[BD:STG-124]`
  - **Type**: task
  ...
  - **Verify**: The planning tests pass against the implemented UI
  - **Accept**: Planning and collaboration behavior is confirmed by automated tests

- [x] **Task 3: Wire realtime sync, conflict states, and copy-week UX** `[BD:STG-126]`
  - **Type**: feature
...
- [x] **Task 4: Verify planning in real browser collaboration flows** `[BD:STG-127]`
  - **Type**: task
...
- [x] **Task 5: Update manifest** `[BD:STG-128]`
  - **Type**: chore
