...
1. Implement the recipe pages first; add route and E2E tests afterward to confirm the journeys
...
- [x] **Task 1: Implement recipe library, detail, and import routes** `[BD:STG-120]`
  - **Type**: feature
  ...
  - **Verify**: Route tests pass and browser smoke reaches each page once tests are added
  - **Accept**: Users can discover, inspect, and import recipes through real routes

- [x] **Task 2: Add recipe-page route and E2E tests** `[BD:STG-119]`
  - **Type**: task
  ...
  - **Verify**: The recipe-page tests pass against the implemented pages
  - **Accept**: Recipe journeys are explicit before the page layer is built

- [x] **Task 3: Implement scaling, substitutions, and cooking mode** `[BD:STG-121]`
  - **Type**: feature
...
- [x] **Task 4: Verify recipe flows offline and in-browser** `[BD:STG-122]`
  - **Type**: task
...
- [x] **Task 5: Update manifest** `[BD:STG-123]`
  - **Type**: chore
