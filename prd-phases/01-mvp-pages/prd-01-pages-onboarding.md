...
1. Start with failing route and E2E tests for the onboarding journey
...
- [ ] **Task 1: Add failing onboarding route and flow tests** `[BD:STG-114]`
  - **Type**: task
  ...
  - **Verify**: The onboarding suite fails before UI implementation starts
  - **Accept**: The onboarding journey is explicit before the page is built

- [ ] **Task 2: Implement the multi-step onboarding route** `[BD:STG-115]`
  - **Type**: feature
  ...
  - **Verify**: Route and interaction tests pass
  - **Accept**: Users can move through onboarding end-to-end in the browser

- [ ] **Task 3: Wire auth, pantry templates, and installability hooks** `[BD:STG-116]`
  - **Type**: feature
...
- [ ] **Task 4: Verify onboarding in browser and mobile emulation** `[BD:STG-117]`
  - **Type**: task
...
- [ ] **Task 5: Update manifest** `[BD:STG-118]`
  - **Type**: chore
