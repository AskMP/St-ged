...
- [ ] **Task 1: Create root package.json and workspace config** `[BD:STG-5]`
  - **Type**: task
...
- [ ] **Task 2: Create shared types package** `[BD:STG-6]`
  - **Type**: task
...
- [ ] **Task 3: Create shared db package skeleton** `[BD:STG-7]`
  - **Type**: task
...
- [ ] **Task 4: Create shared usda package skeleton** `[BD:STG-8]`
  - **Type**: task
...
- [ ] **Task 5: Create Vite + React web app skeleton** `[BD:STG-9]`
  - **Type**: task
...
- [ ] **Task 7: Create root tsconfig** `[BD:STG-11]`
  - **Type**: task
...
- [ ] **Task 8: Verify full dev setup** `[BD:STG-12]`
  - **Type**: task
...
- [ ] **Task 9: Update manifest** `[BD:STG-13]`
  - **Type**: chore
  - **Do**: Open `prd-phases/manifest.md`. Find the registry entry for `00b`. Change `status: pending` to `status: complete`. Update Current State: "Last completed PRD" = `00b`, increment progress to `2 / 29 PRDs complete`. Confirm `00c` and `00d` (both require 00b) are now unblocked.
  - **Files**: `prd-phases/manifest.md`
  - **Verify**: `grep "00b" prd-phases/manifest.md` shows `status: complete`
  - **Accept**: Manifest updated; progress = 2/29
